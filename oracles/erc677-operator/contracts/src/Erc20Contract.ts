...
// Credit: https://github.com/o1-labs/o1js/blob/main/src/examples/zkapps/dex/erc20.ts
...
// Problem: Extends TokenContract, Got instance.[methodName] not found.
// export class Erc20Contract extends TokenContract implements Erc20 {
